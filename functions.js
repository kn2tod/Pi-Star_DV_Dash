...
function checkFrequency(){
  ...
  if(freqPOCSAG){
    ...
    if (1240 <= intFreqPOCSAG && intFreqPOCSAG <= 1300) { pocsagFrequency.style.backgroundColor = goodColor; }
    // TX Bad
    ...
    if (1260 <= intFreqPOCSAG && intFreqPOCSAG <= 1270) { pocsagFrequency.style.backgroundColor = badColor; }
  }
}
