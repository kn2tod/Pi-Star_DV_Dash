...
exec('sudo cp /etc/ysf2p25 /tmp/7ta1tYbCgtHPkJ.tmp');
exec('sudo chown www-data:www-data /tmp/7ta1tYbCgtHPkJ.tmp');
exec('sudo chmod 664 /tmp/7ta1tYbCgtHPkJ.tmp');

// ini file to open
$filepath = '/tmp/7ta1tYbCgtHPkJ.tmp';
...
// this is the function going to update your ini file
	function update_ini_file($data, $filepath) {
		...
		exec('sudo cp /tmp/7ta1tYbCgtHPkJ.tmp /etc/ysf2p25');		// Move the file back
