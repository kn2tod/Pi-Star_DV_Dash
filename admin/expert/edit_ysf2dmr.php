...
exec('sudo cp /etc/ysf2dmr /tmp/q7Ch6yjUqU7FSD.tmp');
exec('sudo chown www-data:www-data /tmp/q7Ch6yjUqU7FSD.tmp');
exec('sudo chmod 664 /tmp/q7Ch6yjUqU7FSD.tmp');

// ini file to open
$filepath = '/tmp/q7Ch6yjUqU7FSD.tmp';
...
// this is the function going to update your ini file
	function update_ini_file($data, $filepath) {
		...
		exec('sudo cp /tmp/q7Ch6yjUqU7FSD.tmp /etc/ysf2dmr');		// Move the file back
