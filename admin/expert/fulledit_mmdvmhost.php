...
if(isset($_POST['data'])) {
        // File Wrangling
        exec('sudo cp /etc/mmdvmhost /tmp/fmehg65695mp.tmp');
        exec('sudo chown www-data:www-data /tmp/fmehg65695mp.tmp');
        exec('sudo chmod 664 /tmp/fmehg65695mp.tmp');

        // Open the file and write the data
        $filepath = '/tmp/fmehg65695mp.tmp';
        $fh = fopen($filepath, 'w');
