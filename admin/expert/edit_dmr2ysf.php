...
exec('sudo cp /etc/dmr2ysf /tmp/KSJzQcgGc5XgW9.tmp');
exec('sudo chown www-data:www-data /tmp/KSJzQcgGc5XgW9.tmp');
exec('sudo chmod 664 /tmp/KSJzQcgGc5XgW9.tmp');

// ini file to open
$filepath = '/tmp/KSJzQcgGc5XgW9.tmp';
...
// this is the function going to update your ini file
	function update_ini_file($data, $filepath) {
		...
		exec('sudo cp /tmp/KSJzQcgGc5XgW9.tmp /etc/dmr2ysf');		// Move the file back
