...
exec('sudo cp /etc/dmr2nxdn /tmp/cshgwXizVoKvXt.tmp');
exec('sudo chown www-data:www-data /tmp/cshgwXizVoKvXt.tmp');
exec('sudo chmod 664 /tmp/cshgwXizVoKvXt.tmp');

// ini file to open
$filepath = '/tmp/cshgwXizVoKvXt.tmp';
...
// this is the function going to update your ini file
	function update_ini_file($data, $filepath) {
		...
		exec('sudo cp /tmp/cshgwXizVoKvXt.tmp /etc/dmr2nxdn');		// Move the file back
