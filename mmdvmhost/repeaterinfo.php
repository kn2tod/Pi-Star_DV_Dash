...
<table>
  ...
  <tr><?php showMode("M17", $mmdvmconfigs);?><?php showMode(" ", $mmdvmconfigs);?></tr>
</table>
<br />
...
<table>
  ...
  <tr><?php showMode("M17 Network", $mmdvmconfigs);?><?php showMode(" ", $mmdvmconfigs);?></tr>
</table>
<br />
...
if (isset($lastHeard[0])) {
	...
	if ($xElem !== null) {
        	...
        	elseif ($amode === 'P25') {
                ...
                elseif ($listNull == null && $amode === 'M17') {
...
if ( $testYSF2DMR ) { //Hide the YSF2DMR information when YSF2DMR Network mode not enabled.
	...
	$ysf2dmrid = "";
	if (isset($configysf2dmr['DMR Network']['Id'])) { $ysf2dmrid = $configysf2dmr['DMR Network']['Id']; }
        echo "<br />\n";
        echo "<table>\n";
        echo "<tr><th colspan=\"2\">YSF2DMR</th></tr>\n";
	echo "<tr><th>DMR ID</th><td style=\"background: #ffffff;\">".$ysf2dmrid."</td></tr>\n";
